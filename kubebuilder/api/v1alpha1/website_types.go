...
type WebsiteSpec struct {
	...
	// Use valueFrom.secretKeyRef to inject values from a Kubernetes Secret
	// (e.g. credentials generated by a database operator) without storing
	// them in the Website spec itself.
	// +listType=map
	// +listMapKey=name
	// +optional
